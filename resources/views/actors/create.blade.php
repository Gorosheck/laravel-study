    ...
    <div class="row w-50 d-flex">
        <form action="{{ route('actors.create') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input value="{{ old('first_name') }}" name="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror">
                @error('first_name')
            ...
            <div class="form-group">
                ...
                <input value="{{ old('last_name') }}" name="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror">
                @error('last_name')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input value="{{ old('birthday') }}" name="birthday" type="date" class="form-control @error('birthday') is-invalid @enderror">
                @error('birthday')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input value="{{ old('height') }}" name="height" type="text" class="form-control @error('height') is-invalid @enderror">
                @error('height')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
